      ...
      >
        <nav className="flex bg-primary-default lg:w-[90%] lg:h-auto h-[70px] w-full m-auto justify-between bg-primary py-6 px-8 z-[999] top-0 right-0 fixed lg:relative  rounded-none items-center lg:rounded-bl-24 lg:rounded-br-24">
          <div
            ...
            className="flex lg:hidden flex-col gap-[6px] hamburger cursor-pointer"
          >
            <img
              className={`select-none transition-transform duration-300 ${
                !show ? "rotate-45 translate-y-2" : "rotate-0"
              }`}
              src={rectangle}
            />
            <img
          ...
          <div className=" hidden lg:block">
            <Link
              className="mx-3 hover:text-[#e32682] transition-all duration-500"
              to="/"
            >
              {t("navbar.home")}
            </Link>
          ...
          <div className="flex items-center">
            ...
            <div className="text-[#101426] font-medium text-xl ml-6 hover:text-[#fff] transition-all duration-500 headerBuyTicket">
              <button className="bg-white px-8 py-2 rounded-lg align-middle hidden lg:inline-block">
                {t("navbar.buytickets")}
              </button>
              <button className="bg-white px-2 py-2 rounded-lg align-middle mx-[1px]">
                <IoTicket className="w-5 h-7" />
              </button>
            </div>
          </div>
        </nav>
        ...
        <div
          className={`xs:w-64 w-full pt-16 h-full px-4 mt-14 bg-white fixed top-0 z-[500] ${
            show && "close"
          } duration-500`}
        >
          <LanguageSelector isMobileNavbar={true} />
          ...
          <div className="flex flex-col gap-4 mt-7 text-primary-default font-semibold tracking-wider text-xl">
            <Link
              className="mx-3 hover:text-[#e32682] text-primary transition-all duration-500"
              to="/"
            >
              {t("navbar.home")}
            </Link>
