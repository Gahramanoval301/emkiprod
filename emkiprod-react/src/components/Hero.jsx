    ...
    return (
      <div className='hero text-white'>
                    ...
                    <p className='whitespace-normal text-base font-normal mb-7'>{t("home.welcometotheultimatedestinationformusicenthusiastsandconcertgoersatemkiproductionwerepassionateaboutbringingyoutheverybestinlivemusicexperienceswhetheryoureadiehardfanoracasuallistenerwevegotsomethingspecialinstoreforyou")}</p>
                            <button onClick={() => navigate('/events')}  className='bg-white_ text-primary-default font-semibold tracking-wider px-8 py-2 rounded-lg align-middle text-primary flex gap-3 items-center hover:bg-[#e32682] hover:text-[#fff] transition-all duration-500'>Events <FaCircleArrowRight />  </button>
                        </div>
                        <div className='w-4/5'>
                            <HeroSliderDesktop />
                        </div>
